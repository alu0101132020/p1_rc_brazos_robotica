...
d  = [p[0], 0,    0,         0,         5, -p[4], p[4], 0, 0,    0,    0,        0]
th = [   0, 0, p[1], p[2] + 90, p[3] + 90,    90,   90, 0, 0,    0,    0,        90]
a  = [   0, 2,    2,         0,         0,     0,    0, 1, 1, p[5], p[5], p[5] + 1]
...
T4p2 = matriz_T(d[5], th[5], a[5], al[5])
T4p3 = matriz_T(d[6], th[6], a[6], al[6])
Tp351 = matriz_T(d[7], th[7], a[7], al[7])
Tp352 = matriz_T(d[8], th[8], a[8], al[8])
...
T03 = np.dot(T02, T23)
T04 = np.dot(T03, T34)
T0p2 = np.dot(T04, T4p2)
T0p3 = np.dot(T04, T4p3)
T0p351 = np.dot(T0p2, Tp351)
T0p352 = np.dot(T0p3, Tp352)
T05161 = np.dot(T0p351, T5161)
T05262 = np.dot(T0p352, T5262)
T04ef = np.dot(T04, T4ef)
...
op20 = np.dot(T0p2, op2).tolist()
op30 = np.dot(T0p3, op3).tolist()
o510 = np.dot(T0p351, o51).tolist()
o520 = np.dot(T0p352, o52).tolist()
o610 = np.dot(T05161, o61).tolist()
o620 = np.dot(T05262, o62).tolist()
oef0 = np.dot(T04ef, oef).tolist()

# Mostrar resultado de la cinemática directa
muestra_origenes([o00, op10, o10, o20, o30, o40, [[op20, o510, o610], [op30, o520, o620]]], oef0)
muestra_robot   ([o00, op10, o10, o20, o30, o40, [[op20, o510, o610], [op30, o520, o620]]], oef0)
input()
